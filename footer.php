    ...
    <footer id="mainfooter" class="container">
      <div class="panel panel-default">
        ...
        <div class="panel-footer clearfix footer-div">
		  ...
		  ?>
          <span class="pull-right">Theme <a href="https://github.com/RocketHcgs/Fresh" target="_blank">Fresh</a>. | Based on <a href="http://getbootstrap.com/" target="_blank">Bootstrap</a>.</span>
        </div>
      </div>
    </footer>
    <div class="float-nav">
